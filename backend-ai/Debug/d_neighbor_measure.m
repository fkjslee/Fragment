...
% parts = 
first_num = split(pics{1}, '_');
first_num = str2num(char(first_num(2)));
sec_num = split(pics{2}, '_');
sec_num = str2num(char(sec_num(2)));
parts = [first_num sec_num];
pairs=nchoosek(1:n_pics,2);
n_pairs=size(pairs,1);
series = split(pics{1}, '/');
series = char(series(1));
